...
/**
 * Panneau pour saisir la valeur d'un paramètre de personnalisation, dans un champ texte.
 */
@SuppressWarnings("serial")
public class CustomizationPropertyTextValuePanel extends Panel {

    protected static final Logger logger = Logger.getLogger(CustomizationPropertyTextValuePanel.class.getName());
     ...
     * @param defaultValue            la valeur du texte par défaut
     */
    public CustomizationPropertyTextValuePanel(String id, String customizationName, Map<Locale, String>
            customizationClassLabel, String defaultValue) {
        super(id);
        ...
        main.add(new Label("customizationLabel", new Model<String>() {
            @Override
        ...
        TextField<String> ddc = new TextField<>("customizationClass_options", valueModel);
        ddc.add(new AjaxFormComponentUpdatingBehavior("onchange") {
            protected void onUpdate(AjaxRequestTarget target) {
                String selected = this.getComponent().getDefaultModelObjectAsString();
                logger.debug("Saisie : " + selected);
                try {
        ...
        form.add(ddc.add(AttributeModifier.append("placeholder", valueModel)));
    }
